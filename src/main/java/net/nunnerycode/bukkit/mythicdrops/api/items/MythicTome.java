...
public class MythicTome extends MythicItemStack {
  ...
  /**
   * Instantiates a new MythicTome with a specified {@link MaterialData} of a {@link TomeType}. It
   * is also instantiated with a specified title and author, specified lore and pages.
   *
