...
public final class MythicEnchantment {
  ...
  /**
   * Instantiate a new MythicEnchantment with an {@link Enchantment} and a minimum and maximum
   * level.
   *
  ...
  /**
   * Returns the range between the minimum and maximum levels of the Enchantment. <br> Equivalent of
   * {@code {@link #getMaximumLevel()} - {@link #getMinimumLevel()} }
   *
