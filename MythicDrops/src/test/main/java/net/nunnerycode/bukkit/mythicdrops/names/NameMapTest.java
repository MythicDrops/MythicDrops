...
public class NameMapTest {
	...
	public void testGetMatchingKeys() throws Exception {
		...
		nameMap.put(NameType.MATERIAL_PREFIX.getFormat() + "DIAMOND_SWORD", Arrays.asList("foo", "bar", "foobar"));
		nameMap.put(NameType.MATERIAL_PREFIX.getFormat() + "DIAMOND_PICKAXE", Arrays.asList("foo", "bar", "foobar"));
		nameMap.put(NameType.MATERIAL_PREFIX.getFormat() + "DIAMOND_AXE", Arrays.asList("foo", "bar", "foobar"));
		nameMap.put(NameType.MATERIAL_SUFFIX.getFormat() + "DIAMOND_SWORD", Arrays.asList("foo", "bar", "foobar"));

		List<String> matchingKeys = nameMap.getMatchingKeys(NameType.MATERIAL_PREFIX);

		Assert.assertNotNull(matchingKeys);
		Assert.assertTrue(matchingKeys.contains(NameType.MATERIAL_PREFIX.getFormat() + "DIAMOND_SWORD"));
		Assert.assertTrue(matchingKeys.contains(NameType.MATERIAL_PREFIX.getFormat() + "DIAMOND_PICKAXE"));
		Assert.assertTrue(matchingKeys.contains(NameType.MATERIAL_PREFIX.getFormat() + "DIAMOND_AXE"));
		Assert.assertFalse(matchingKeys.contains(NameType.MATERIAL_SUFFIX.getFormat() + "DIAMOND_SWORD"));
	}
