...
public class MythicItemStack extends ItemStack {
	 ...
	 */
	public MythicItemStack(MaterialData type, int amount, short durability, String displayName, List<String> lore,
	 ...
	 * @param enchantments enchantments for item
	 */
	public MythicItemStack(MaterialData type, int amount, short durability, Map<Enchantment, Integer> enchantments) {
	 ...
	 * @param enchantments enchantments for item
	 */
	public MythicItemStack(MaterialData type, int amount, short durability, String displayName, Map<Enchantment,
	 ...
	 * @param enchantments enchantments for item
	 */
	public MythicItemStack(MaterialData type, int amount, short durability, List<String> lore, Map<Enchantment,
			Integer> enchantments) {
