...
![Item without Socket Extender slot](./images/itemwithoutsocketextenderslot.png)

![Socket Extender](./images/socketextender.png)

![Item with new empty socket](./images/itemwithnewsocket.png)

### Limited Number of Socket Extender Slots

![Limited number of Socket Extender Slots](./images/limitednumberofsocketextenderslots.png)

![One Socket Extender slot used](./images/onesocketextenderslottakenup.png)
