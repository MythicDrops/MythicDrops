...
command:
  ...
  drop-token:
    success: "&6[MythicDrops] &AYou dropped &F%amount%&A &FToken(s)&A."
    failure: "&6[MythicDrops] &CYou were unable to drop &F%amount%&C &FToken(s)&C."
  drop-tome:
  ...
  give-token:
    sender-success: "&6[MythicDrops] &F%receiver%&A was given &F%amount%&A &FToken(s)&A."
    sender-failure: "&6[MythicDrops] &F%receiver%&C was unable to be given &F%amount%&C &FToken(s)&C."
    receiver-success: "&6[MythicDrops] &AYou have received &F%amount%&A &FToken(s)&A!"
    receiver-failure: "&6[MythicDrops] &CYou were unable to be given &F%amount%&C &FToken(s)&C."
  give-tome:
  ...
  spawn-token:
    success: "&6[MythicDrops] &AYou have received &F%amount%&A &FToken(s)&A."
    failure: "&6[MythicDrops] &CYou were unable to be given &F%amount%&C &FToken(s)&C."
  spawn-tome:
