...
mythicdrops.command.drop.extender:
...
mythicdrops.command.drop.*:
  ...
  children:
    ...
    mythicdrops.command.drop.extender: true
...
mythicdrops.command.give.extender:
...
mythicdrops.command.give.*:
  ...
  children:
    ...
    mythicdrops.command.give.extender: true
...
mythicdrops.command.spawn.extender:
...
mythicdrops.command.spawn.*:
  ...
  children:
    ...
    mythicdrops.command.spawn.extender: true
