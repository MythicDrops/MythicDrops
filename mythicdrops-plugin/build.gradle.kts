...
description = "MythicDrops :: Plugin"
...
dependencies {
    ...
    implementation("cloud.commandframework:cloud-annotations:_")
    implementation("cloud.commandframework:cloud-core:_")
    implementation("cloud.commandframework:cloud-minecraft-extras:_")
    implementation("cloud.commandframework:cloud-paper:_")
...
tasks.findByName("sourceJar")?.dependsOn("generateBuildConfigKt", "kspKotlin")

tasks.create("assembleDist", Zip::class.java) {
    dependsOn("shadowJar")
    archiveBaseName.value("MythicDrops")
