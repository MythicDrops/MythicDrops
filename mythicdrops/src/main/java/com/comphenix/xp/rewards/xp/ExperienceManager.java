 ...
 * .54450/#post-1067480) for an implementation that avoids the problems of getTotalExperience(),
 * which doesn't work properly after a player has enchanted something.
 *
 * <p>Modified by Comphenix.
 *
 * @author desht
 */
public class ExperienceManager {
   ...
   * .net/browse/BUKKIT-47 </br> 7 XP to get to level 1, 17 to level 2, 31 to level 3... At each
   * level, the increment to get to the next level increases alternately by 3 and 4
   *
   ...
   * This is needed if getLevelForExp() is called with an XP quantity beyond the range of the
  ...
  /**
   * Adjust the player's XP by the given amount in an intelligent fashion. Works around some of the
   * non-intuitive behavior of the basic Bukkit player.giveExp() method.
   *
